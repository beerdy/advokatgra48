...
(function ($) {
    var o = $('.resp-tabs');
    if (o.length > 0) {
        include('/assets/jquery.responsive.tabs.js');
...
(function ($) {
    var o = $('.accordion');
    if (o.length > 0) {
        include('/assets/jquery.ui.accordion.min.js');
...
(function ($) {
    var o = $('#contact-form');
    if (o.length > 0) {
        include('/assets/modal.js');
        include('/assets/TMForm.js'); 

        if($('#contact-form .recaptcha').length > 0){
            include('//www.google.com/recaptcha/api//assets/recaptcha_ajax.js');
        }
    }
})(jQuery);
...
;(function ($) {
    ...
    if (o.length > 0) {
        ...
        include('/assets/jquery.fancybox-media.js');
