...
class SlidersControllerTest < ActionController::TestCase
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post :create, slider: { description: @slider.description, image_uid: @slider.image_uid, title: @slider.title }
    end
  ...
  test "should update slider" do
    patch :update, id: @slider, slider: { description: @slider.description, image_uid: @slider.image_uid, title: @slider.title }
    assert_redirected_to slider_path(assigns(:slider))
  end
