...
class TarifsControllerTest < ActionController::TestCase
  ...
  test "should create tarif" do
    assert_difference('Tarif.count') do
      post :create, tarif: { description: @tarif.description, group_id: @tarif.group_id, title: @tarif.title }
    end
  ...
  test "should update tarif" do
    patch :update, id: @tarif, tarif: { description: @tarif.description, group_id: @tarif.group_id, title: @tarif.title }
    assert_redirected_to tarif_path(assigns(:tarif))
  end
